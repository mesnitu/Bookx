...
$zco_notifier->notify('NOTIFY_MODULE_NEW_PRODUCTS_BEGIN');
//**** eof Bookx mod 1 of 3
...
$zco_notifier->notify('NOTIFY_MODULE_NEW_PRODUCTS_QUERY_BUILT');
...
$zco_notifier->notify('NOTIFY_MODULE_NEW_PRODUCTS_END');
