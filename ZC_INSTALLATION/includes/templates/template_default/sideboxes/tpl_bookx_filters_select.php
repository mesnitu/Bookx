...
if ($show_author_filter) {
    if ($show_author_type_filter) {
        ...
        $content .= zen_draw_form('bookx_author_types_form', zen_href_link($destination_page, '', $request_type, false), 'get', 'class="' . ($active_bx_filter_ids['author_type_id'] ? 'bxf bxf_active' : 'bxf') . '"');
    ...
    $content .= zen_draw_form('bookx_authors_form', zen_href_link(FILENAME_DEFAULT, '', $request_type, false), 'get', 'class="' . ($active_bx_filter_ids['author_id'] ? 'bxf bxf_active' : 'bxf') . '"');
...
if ($show_publisher_filter) {
    ...
    $content .= zen_draw_form('bookx_publishers_form', zen_href_link(FILENAME_DEFAULT, '', $request_type, false), 'get', 'class="' . ('' != $active_bx_filter_ids['publisher_id'] ? 'bxf bxf_active' : 'bxf') . '"');
...
if ($show_imprint_filter) {
    ...
    $content .= zen_draw_form('bookx_imprints_form', zen_href_link(FILENAME_DEFAULT, '', $request_type, false), 'get', 'class="' . ($active_bx_filter_ids['imprint_id'] ? 'bxf bxf_active' : 'bxf') . '"');
...
if ($show_series_filter) {
    ...
    $content .= zen_draw_form('bookx_series_form', zen_href_link(FILENAME_DEFAULT, '', $request_type, false), 'get', 'class="' . ($active_bx_filter_ids['series_id'] ? 'bxf bxf_active' : 'bxf') . '"');
...
if ($show_genre_filter) {
    ...
    $content .= zen_draw_form('bookx_genres_form', zen_href_link(FILENAME_DEFAULT, '', $request_type, false), 'get', 'class="' . ($active_bx_filter_ids['genre_id'] ? 'bxf bxf_active' : 'bxf') . '"');
