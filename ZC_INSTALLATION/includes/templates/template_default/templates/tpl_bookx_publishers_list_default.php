...
<div id="bookxPublisherListing">
    ...
    <div id="bookxPublisherListingTable" class="bookxFilterListAll">
        ...
        foreach ($bookx_publishers_listing_split_array as $publisher) {
            ...
            echo '<div class="row clearfix">' . zen_image($publisher['publisher_image'], $publisher['publisher_name'], BOOKX_PUBLISHER_LISTING_IMAGE_MAX_WIDTH, BOOKX_PUBLISHER_LISTING_IMAGE_MAX_HEIGHT, 'class="bookxAllListingImage"');
            echo '<h3 class="bookxAllListingInfo"><span class="bookxPublisherName">' . $publisher['publisher_name'] . '</span></h3>'
            . (!empty($publisher['publisher_description']) ? '<div class="bookxAllListingDescription">' . zen_html_entity_decode(bookx_truncate_paragraph($publisher['publisher_description'], BOOKX_TRUNCATE_DESCRIPTION_LENGHT)) . '</div>' : '')
