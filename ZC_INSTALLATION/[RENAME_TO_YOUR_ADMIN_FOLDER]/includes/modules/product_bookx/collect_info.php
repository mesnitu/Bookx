...
<script type="text/javascript">
  ...
  function determineBookxProductStatusMessage() {
      ...
      if (<?php echo SHOW_NEW_PRODUCTS_LIMIT; ?> !== 0) {
                            ...
                            ?>
          statusMessage += '<span class="bookx_article_status_explain"><?php
                        printf(TEXT_ZC_NEW_PRODUCTS_LIMIT_WARNING, $check_configure->fields['configuration_title'], $check_configure->fields['configuration_value'], zen_href_link(FILENAME_CONFIGURATION, 'gID=' . $check_configure->fields['configuration_group_id'] . '&cID=' . $check_configure->fields['configuration_id'])
                        );
                        ?></span>';
      }
