...
/**
 * @todo see usability
 * @since version 096 adding a notifier
 */
  ...
  <div class="panel-heading">
      <div class="row">
          <div class="col-sm-8 pageHeading">
              <?php
              $lng_icon = DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'];
               ?>
          ...
          <div class="col-sm-4 text-right pageHeading">
			  <?php echo $currencies->format($pInfo->products_price) . ' - <span class="text-danger">' . $currencies->format($specials_price) . '</span>'; ?>
